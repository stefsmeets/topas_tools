...
for cif in cifs:
	...
	str
		...
		if sg.crystal_system() == 'Monoclinic':
			string = "{s400}{s040}{s004}{s220}{s202}{s022}{s301}{s121}{s103}{eta}".format(s400=s400, s040=s040, s004=s004, s220=s220, s202=s202, s022=s022, s301=s301, s121=s121, s103=s103, eta=eta)
			macro = "		'Stephens_monoclinic(s400, s040, s004, s220, s202, s022, s301, s121, s103, eta)"

		elif sg.crystal_system() == 'Tetragonal':
			string = "{s400}{s004}{s220}{s202}{eta}".format(s400=s400, s040=s040, s004=s004, s220=s220, s202=s202, s022=s022, s301=s301, s121=s121, s103=s103, eta=eta)
			macro = "		'Stephens_tetragonal(s400, s004, s220, s202, eta)"

		elif sg.crystal_system() == 'Hexagonal':
			string = "{s400}{s004}{s202}{eta}".format(s400=s400, s040=s040, s004=s004, s220=s220, s202=s202, s022=s022, s301=s301, s121=s121, s103=s103, eta=eta)
			macro = "		'Stephens_hexagonal(s400, s202, s004, eta)"

		elif sg.crystal_system() == 'Orthorhombic':
			string = "{s400}{s040}{s004}{s220}{s202}{s022}{eta}".format(s400=s400, s040=s040, s004=s004, s220=s220, s202=s202, s022=s022, s301=s301, s121=s121, s103=s103, eta=eta)
		...
		for atom in scatterers:
			...
			if mult < z_order:
				print "        ' {:6s} {:6s} {:6s}".format(*sps.site_symmetry(atom.site).special_op_simplified().terms)
			else:
				print
